...
class RecipeControllerSBTest {
    ...
    void setUp() throws Exception {
        ...
        when(htmlPreprocessor.process(anyString(), anyString()))
                .thenAnswer(invocation -> {
                    ...
                    return new HtmlCleaner.Results(html, size, size, 1.0, Strategy.DISABLED,
                            "Test metrics");
                });
    }
    ...
    void createRecipeFromCompressedHtml() throws IOException, AuthenticationException {
        ...
        assertThat(response.getBody())
                ...
                .containsExactly("Test Recipe", "http://example.com", true);
    }
    ...
    @Test
    void createRecipe_whenStorageServiceFailsWithGenericException_shouldReturnInternalServerError()
            throws Exception {
        // Given
        Request request = new Request(null, "Title", "http://example.com");
        when(storageService.getStorageInfo(anyString()))
