...
class RecipePostProcessorTest {
    ...
    void testProcess_normalCase() {
        ...
        assertEquals(LocalDate.now(), processed.metadata().dateCreated(), "Date created should be today");
    ...
    void testProcess_nullMetadata() {
        ...
        assertEquals(LocalDate.now(), processed.metadata().dateCreated());
    ...
    void testProcess_immutability() {
        ...
        assertEquals("https://old-source.com", originalRecipe.metadata().source(), "Original source should be unchanged");
        assertEquals(LocalDate.of(2020, 1, 1), originalRecipe.metadata().dateCreated(), "Original date should be unchanged");
    }
    ...
    void testProcess_customSchemaVersion() {
        ...
        Recipe recipe = new Recipe(
                ...
                "0.9.0",
                "2.0.0",
                new RecipeMetadata("Test Recipe", null, null, null, null, null, null, null, null, null, null, null, null),
                "Test description",
                List.of(new Ingredient("flour", "2 cups", "cups", null, null, null, null)),
                List.of("bowl"),
                List.of(new Instruction(1, "Mix ingredients", null, null, null)),
    ...
    void testProcess_isRecipeFalse() {
        ...
        Recipe recipe = new Recipe(
                ...
                "0.9.0",
                "2.0.0",
                new RecipeMetadata("Not a Recipe", null, null, null, null, null, null, null, null, null, null, null, null),
                "Test description",
                List.of(new Ingredient("flour", "2 cups", "cups", null, null, null, null)),
                List.of("bowl"),
                List.of(new Instruction(1, "Mix ingredients", null, null, null)),
